 ...
 * Part 3.5 — Tech Stack validation now normalizes (trim + dedupe + drop empty)
 * ---------------------------------------------------------------------------
...
export async function PUT(req: NextRequest) {
  ...
  // ── TechStack validation + normalization (Part 3.5) ────────────────────
  if (body.techStack !== undefined) {
    ...
    body.techStack = normalizeTechStack(body.techStack)
  }
