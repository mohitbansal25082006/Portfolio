 ...
 *   - PDF viewer uses admin-pdf-viewer-height for proper mobile display
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <p className="text-base sm:text-lg font-bold tabular-nums leading-tight truncate">{value}</p>
    ...
    >
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="admin-main-scroll flex-1 overflow-y-auto p-3 sm:p-6 lg:p-8 admin-content-safe-bottom">
          ...
          {/* Stat pills */}
          <div className="mb-8 grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-3">
            <StatPill
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-[0.45fr_0.55fr]">
            {/* Upload panel */}
            <div className="rounded-2xl border p-4 sm:p-6" style={{ background: 'var(--card)', borderColor: 'var(--border)' }}>
              ...
              <div
                ...
                role="button"
                tabIndex={0}
                className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl border-2 border-dashed px-4 sm:px-6 py-8 sm:py-10 text-center transition-colors"
                style={{
              ...
              >
                ...
                {uploading ? (
                  ...
                  <>
                    ...
                    >
                      <UploadCloud className="h-5 w-5 sm:h-6 sm:w-6" style={{ color: 'var(--primary)' }} />
                    </span>
            ...
            <div className="rounded-2xl border p-4 sm:p-6" style={{ background: 'var(--card)', borderColor: 'var(--border)' }}>
              ...
              {loadingMeta ? (
                <div
                  className="admin-pdf-viewer-height flex items-center justify-center rounded-2xl border"
                  style={{ borderColor: 'var(--border)', background: 'var(--muted)', minHeight: '300px' }}
                >
                  <Loader2 className="h-6 w-6 animate-spin" style={{ color: 'var(--muted-foreground)' }} />
                </div>
              ) : meta ? (
                <div className="admin-pdf-viewer-height min-h-[300px]">
                  <PdfViewer key={previewKey} url={meta.url} fileName={meta.fileName} />
                </div>
              ) : (
                <div
                  className="admin-pdf-viewer-height flex items-center justify-center rounded-2xl border text-sm"
                  style={{ borderColor: 'var(--border)', background: 'var(--muted)', color: 'var(--muted-foreground)', minHeight: '300px' }}
                >
